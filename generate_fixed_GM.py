...
if __name__ == '__main__':
    ...
    if os.path.exists('fixed_GM_samples'):
        shutil.rmtree('fixed_GM_samples')
    os.makedirs('fixed_GM_samples', exist_ok=True)
    ...
    with torch.no_grad():
        while n_samples<10000:
            ...
            for k in range(x.shape[0]):
                if n_samples<10000:
                    torchvision.utils.save_image(x[k:k+1], os.path.join('fixed_GM_samples', f'{n_samples}.png'))         
                    n_samples += 1