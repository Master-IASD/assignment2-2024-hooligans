...
from utils import D_train, G_train, save_models, G_train_fixed_GM
...
if __name__ == '__main__':
    ...
    for epoch in trange(1, n_epoch+1, leave=True):           
        for batch_idx, (x, _) in enumerate(train_loader):
            ...
            G_train_fixed_GM(x, G, D, G_optimizer, criterion, K, sigma, c, latent_dim=200)
        if epoch % 10 == 0:
            save_models(G, D, f'fixed_GM_checkpoints/d={latent_dim}_c={c}_K={K}_sigma={sigma}/')
